...
def setup_product():
    ...
    import collective.TemplateUploadCenter
    zcml.load_config('configure.zcml', collective.TemplateUploadCenter)
    ...
    ztc.installPackage('collective.TemplateUploadCenter')
...
setup_product()
ptc.setupPloneSite(products=['collective.TemplateUploadCenter'])
